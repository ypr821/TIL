...
의존성 직접 해결 방법([아래에 설명 참고](https://github.com/ypr821/TIL/new/main/2021_10#%EC%9D%98%EC%A1%B4%EC%84%B1-%EC%A7%81%EC%A0%91-%ED%95%B4%EA%B2%B0-%EB%B0%A9%EB%B2%95))으로 클래스를 직접 인스턴스하여 의존관계를 나타낼 수 있다. 즉 개발자가 직접 객체를 제어하여 A객체는 B객체에게 의존하고 있어 라고 클래스를 통해 표현하고 개발자가 직접 표현 한다. 

스프링을 통한 @Autowired를 통한 속성에 의존성 주입하는 방법([아래에 설명 참고](https://github.com/ypr821/TIL/new/main/2021_10#-%EC%8A%A4%ED%94%84%EB%A7%81%EC%9D%84-%ED%86%B5%ED%95%9C-%EC%9D%98%EC%A1%B4%EC%84%B1-%EC%A3%BC%EC%9E%85%ED%95%98%EA%B8%B0-3----autowired%EB%A5%BC-%ED%86%B5%ED%95%9C-%EC%86%8D%EC%84%B1-%EC%A3%BC%EC%9E%85))은  컨테이너에 의해서 생성한 객체를 사용하기만 한다.
...
- 생성자를 통한 의존성 주입의 문제은 한번 타이어를 장착하면 더 이상 타이어를 교체할 방법이 없다는 점인데 이 문제를 속성을 통한 의존성 주입하여 해결 할 수 있다.
